...
module shallwemove::shallwemove_tests {
  ...
  #[test_only] 
  fun create_game(r: &Random) : (Casino, Lounge) {
    ...
    cardgame::add_game_table_test(&casino, &mut lounge, 5, 5, 3, r, ctx);
  ...
  //   let (casino, mut lounge) = create_game(r);
