#[test_only]
module three_cards_poker::shallwemove_tests {
  ...
  fun create_game() : (Casino, Lounge) {
    ...
    let mut lounge = lounge::new(&casino, 2, ctx);
  ...
  fun test_three_cards_poker() {
    ...
    let user_public_key = vector<u8>[51,53,50,54,51];
    ...
    debug::print(&string::utf8(b"===================================================== 3-1 BET ===================================================="));
    cardgame::action_test(&casino, &mut lounge, game_table_id, player_info::CONST_BET(), 0, ctx1);
    debug::print(&string::utf8(b"===================================================== 3-2 CALL ===================================================="));
    cardgame::action_test(&casino, &mut lounge, game_table_id, player_info::CONST_CALL(), 0, ctx2);
